    ...
    <style type="text/css">
        ...
        *{
        ...
        @font-face {
            ...
            src: url('fonts/造字工房尚真体字体.ttf');/*字体源文件*/
        }
    </style>
...
<div data-options="region:'north',split:true" style="height:95px;">
    <div style="margin: 0px 50px;" >
        <img  src="images/login/carlogo.png" height="80px">
    </div>
    <div style="position:absolute; left: 35%;top: 10px">
        <p  style="font-family: MyNewFont"><font color="#4ac9ff" size="7px">GoCar</font><font size="7px" color="#ff508b">出行</font><font color="#" size="4px">&nbsp;共享汽车管理系统V1.0</font></p>
    </div>
...
<div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    <div id="aa" class="easyui-accordion" style="width:193px" data-options="multiple:true,border:0">
        ...
        <div title="汽车信息管理" data-options="iconCls:'icon-search'" style="overflow:auto;padding:10px;">
            <ui>
                <li><a href="javascript:void(0);" pageUrl="car/carManage" >汽车管理</a></li>
        ...
        <div title="租赁信息管理" data-options="iconCls:'icon-ok',selected:true" style="padding:10px;">
            <ui>
                <li><a href="javascript:void(0);" pageUrl="orders/ordersManage"  >汽车租赁</a></li>
            </ui>
        </div>
...
<div data-options="region:'center',title:'内容显示'" style="padding:5px;background:#eee;">
    <div id="tt" class="easyui-tabs"  data-options="fit:true">
        <div title="欢迎页" style="padding:20px;display:none;">
            欢迎登录 GoCar出行共享汽车管理系统！您管理的服务点是${sessionScope.admin.place.pName},位于${sessionScope.admin.place.pAddress}。:-)
        </div>
    </div>
</div>
</body>

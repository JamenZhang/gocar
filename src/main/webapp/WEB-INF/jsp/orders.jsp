    ...
    <div align="center" style="padding-top: 20px">
        <form id = "editForm"  method = "post" enctype="multipart/form-data">
            <table >
                ...
                <tr class="mTr">
                    <td>汽车号：</td><td><input id="oBid" data-options="required:true,validType:'length[0,30]'" class="easyui-validatebox" type ="text" name ="oBid" /></td>
                </tr>
                <tr class="mTr">
                    <td>目前状态：</td>
                    <td>
                        <select id="oState" class="easyui-combobox" data-options="editable:false,required:true"  name="oState" style="width:220px;">
                            <option value="归还,汽车完好">归还,汽车完好</option>
                            <option value="归还,汽车需维修">归还,汽车需维修</option>
                            <option value="归还,汽车已报废">归还,汽车已报废</option>
                        </select>
                    </td>
                </tr>
                <tr class="mTr">
...
<div id="toolbar">
    ...
    <a id = "updateBtn" href="javascript:void(0);" class="easyui-linkbutton" data-options="text:'归还汽车',iconCls:'icon-edit',plain:true"> </a>
    ...
    $(function () {
        ...
        $('#dg').datagrid({
            ...
            columns:[[
                ...
                {field:'oBid',title:'汽车号',width:50,align:'center'},
                {field:'oCash',title:'汽车押金(元)',width:50,align:'center'},
                ...
                {field:'oState',title:'目前状态',width:50,align:'center',formatter: function(value,row,index){
                    if(value == "归还,汽车完好")  return '<font color="green">'+value+'</font>';
        ...
        $("#updateBtn").click(function () {
            ...
            $.messager.confirm('提醒','注意！完好汽车退回押金,需要维修汽车只退押金50%,报废汽车押金没得退回!',function(r){
                if (r){

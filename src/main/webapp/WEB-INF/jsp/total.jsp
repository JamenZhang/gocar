...
<div style="margin: 35px 0 0 180px">
    ...
    <table  class="table" style="width: 930px">
        ...
        <tr>
            <td>车辆总计：</td><td><mark>${total.totalCarCount}</mark></td>
            <td>在库车辆：</td><td><mark>${total.inStoreCarCount}</mark></td>
        </tr>
        <tr>
            <td>需要维修车辆：</td><td><mark>${total.repairCarCount}</mark></td>
            <td>已报废车辆：</td><td><mark>${total.beakdownCarCount}</mark></td>
        </tr>
        <tr>
